...
import TaskForm from './components/TaskForm'; // Importa el formulario para agregar
//tareas
...
const newTask = { text: taskText, completed: false }; // Cada tarea tiene un texto y un
...
const newTasks = tasks.filter((_, index) => index !== taskIndex); // Filtra las tareas
//eliminando la seleccionada
